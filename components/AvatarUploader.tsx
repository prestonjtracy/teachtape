      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            disabled={uploading}
            className="bg-ttOrange text-white px-4 py-2 rounded-lg font-medium hover:bg-ttOrange/90 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ttOrange focus:ring-offset-2"
          >
