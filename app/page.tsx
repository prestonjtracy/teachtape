      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Athletes Love TeachTape
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See what our community has to say about their coaching experience
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#F8FAFC] rounded-2xl p-8 relative">
              <div className="absolute top-6 right-6 text-[#F45A14]/20">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "The film analysis from my coach was incredible. He pointed out things I never noticed in my swing and gave me specific drills to fix them. My batting average went up 50 points!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gradient-to-br from-[#F45A14] to-[#E04D0B] rounded-full flex items-center justify-center">
                  <span className="text-lg font-bold text-white">JM</span>
                </div>
                <div>
                  <p className="font-semibold text-gray-900">Jake M.</p>
                  <p className="text-sm text-gray-500">Baseball Player</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC] rounded-2xl p-8 relative">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "As a parent, I love that I can find qualified coaches for my daughter without driving all over town. The 1:1 lessons have really boosted her confidence on the court."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gradient-to-br from-[#123C7A] to-[#1E5BB5] rounded-full flex items-center justify-center">
                  <span className="text-lg font-bold text-white">SR</span>
                </div>
                <div>
                  <p className="font-semibold text-gray-900">Sarah R.</p>
                  <p className="text-sm text-gray-500">Tennis Parent</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC] rounded-2xl p-8 relative">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "I went from struggling with my serve to hitting aces regularly. Coach Dave's video breakdowns showed me exactly what I was doing wrong. Worth every penny!"
              </p>
              <div className="flex items-center gap-3">
